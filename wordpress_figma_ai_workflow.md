...
Iterate through steps 6.1 – 6.4 for every page section.
       ...
       +------------------------------------+
                         ...
                         v
       +------------------------------------+
       |  6.2 Figma Visual Comparison       |
       +------------------------------------+
                         |
                         v
       +------------------------------------+
       |  6.3 Code & Security Review        |
       +------------------------------------+
                         |
                         v
       +------------------------------------+
...
[ ] Frontend Check: Validate HTML semantical structure, responsiveness, and console errors.

[ ] Backend Check: Verify ACF field readability, Gutenberg block editor preview render, and query performance.

6.4 Commit Work

[ ] Commit section work with descriptive message:
